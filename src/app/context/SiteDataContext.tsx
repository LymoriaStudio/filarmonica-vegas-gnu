...
export const defaultTestimonials: TestimonialItem[] = [
  { id: 1, name: "Lara Araújo França", category: "Aluno", tag: "Afeto e acolhimento", text: "A Filarmônica significa amor, carinho e cuidado. Ela contribuiu para eu aprender a tocar bem, fazer amizades com respeito, amor, carinho, alegria, felicidade, empatia e muito mais.", initials: "LA" },
  { id: 2, name: "Emanuely Lisboa Giunco", category: "Aluno", tag: "Pertencimento e inspiração", text: "Para mim, a Filarmônica é muito mais que um espaço para aprender música. É uma segunda casa, um lugar onde encontro amizade, disciplina e muita inspiração.", initials: "EL" },
  { id: 3, name: "Tainã A. Cipolin", category: "Aluno", tag: "Socialização e felicidade", text: "A Filarmônica me ajudou a ser feliz, porque me socializo cada vez mais e fico alegre com meus amigos. Aprendi bastante coisa e os finalistas mexem com as nossas emoções. O projeto ensina bem, é divertido estar presente e eu acho o projeto incrível.", initials: "TC" },
  { id: 4, name: "Mirella Neves Duarte Galvão", category: "Aluno", tag: "Respeito e trabalho em equipe", text: "Para mim, a Filarmônica significa muito. Foi minha primeira escola de música, ela me abriu uma linha de habilidades para mim e, além disso, me ensinou a respeitar as pessoas. Me mostrou que trabalham em equipe, como uma família. Obrigada, Filarmônica.", initials: "MN" },
  { id: 5, name: "Fellipe Alves Tandin", category: "Aluno", tag: "Aprendizado e comunicação", text: "A Filarmônica representa mais que só uma aula de música. É uma experiência única e divertida para aprender. Ela contribuiu para minha vida social e me ensinou a ser sociável, ter mais paciência e me comunicar melhor.", initials: "FA" },
  { id: 6, name: "Mamãe do Arthur Dias", category: "Pai / Mãe", tag: "Disciplina e responsabilidade", text: "A Filarmônica tem sido muito importante na vida do meu filho. Além de proporcionar o aprendizado musical, ela contribui para o desenvolvimento da disciplina, da responsabilidade e do trabalho em equipe. Percebo que ele ficou mais dedicado, confiante e comprometido com seus objetivos.", initials: "AD" },
  { id: 7, name: "Família do Vinicius", category: "Pai / Mãe", tag: "Acolhimento e socialização", text: "A Filarmônica contribuiu para a socialização e o comprometimento do meu filho Vinicius. Ele conta com acompanhamento de profissionais capacitados e dedicados. O projeto também promove festas comemorativas que as crianças amam. É um lugar acolhedor, uma família.", initials: "FV" },
];
